...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex align-items-md-center align-items-sm-start align-items-start  mb-3 flex-md-row flex-sm-column flex-column">
            <div class="h2 mb-0"><i class="fas fa-book me-2"></i>All Books</div>
        ...
        <div class="row">
            ...
            ?>
                    <div class="col-md-2 col-sm-4 col-4">
                        <a class="card border-0 mb-2 book-card text-decoration-none text-dark" href="view?id=<?= $row['id'] ?>">
                            <div class="card-body">
